...
interface ResourceCardProps {
  resource: Resource;
  selected?: boolean;
  onToggle?: (resource: Resource) => void;
}
...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource, selected = false, onToggle }) => {
  return (
    <button
      type="button"
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {selected && (
          <svg className="w-5 h-5 shrink-0" style={{ color: 'var(--fn-success)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
