...
const REQUIRE_UCU_EMAIL =
  (process.env.NEXT_PUBLIC_REQUIRE_UCU_EMAIL || process.env.NEXT_PUBLIC_REQUIRE_UCU_EMAIL) === 'true';
...
const resolveApiBaseUrl = (): string => {
  let apiBaseUrl = process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_URL || '';
  if (!apiBaseUrl) {
...
export const Login: React.FC = () => {
  ...
  const [localError, setLocalError] = useState(() => searchParams.get('oauth_error_message') || '');
