...
export const CourseModulesTab: React.FC<CourseModulesTabProps> = ({
  ...
  // TODO canonical API: Topic is legacy. Canonical modules expose learningItems directly.
  useEffect(() => {
    setModuleTopics({});
  ...
  const handleSaveTopic = async () => {
    ...
    window.alert(t('modules.topicLegacyDisabled', 'Topics are legacy. Use learning items in the canonical course module API.'));
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          {isLink && resource.externalUrl ? (
            ...
            <Link
              href={`/courses/${courseId}/modules/${module.id}/resources/${resource.id}`}
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              onClick={(event) => {
                ...
                router.push(`/courses/${courseId}/modules/${module.id}/resources/${resource.id}/edit`);
              }}
  ...
  const renderAssignmentRow = (module: Module, assignment: Assignment) => (
    <Link key={assignment.id} href={`/courses/${courseId}/modules/${module.id}/assignments/${assignment.id}`} className="block">
      <div
        ...
        {isInstructor && (
          <div className="flex items-center gap-1">
            <button
              ...
              onClick={(event) => {
                event.preventDefault();
                router.push(`/courses/${courseId}/modules/${module.id}/assignments/${assignment.id}/edit`);
              }}
              className="p-1 transition-colors"
              style={{ color: 'var(--text-faint)' }}
              onMouseEnter={(event) => (event.currentTarget.style.color = 'var(--text-primary)')}
      ...
      {isInstructor && (
        ...
        >
          ...
          <Button
            ...
            onClick={(event) => {
              event.stopPropagation();
              router.push(`/courses/${courseId}/modules/${module.id}/pages`);
            }}
          >
          ...
          <Button
            ...
            onClick={(event) => {
              event.stopPropagation();
              router.push(`/courses/${courseId}/modules/${module.id}/assignments/new`);
            }}
          >
            <PlusIcon className="mr-1 h-4 w-4" />
