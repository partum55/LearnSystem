                ...
                <Menu.Item key={mod.id}>
                  {({ active }) => (
                    <button
                      ...
                      onClick={() => router.push(`/courses/${courseId}/modules/${mod.id}/assignments/new`)}
                    >
                      {mod.title}
                    </button>
                  )}
                        ...
                        {assignment.moduleId && (
                          <button
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              e.stopPropagation();
                              router.push(`/courses/${assignment.courseId}/modules/${assignment.moduleId}/assignments/${assignment.id}/edit`);
                            }}
