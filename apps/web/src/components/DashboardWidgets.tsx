  ...
  return (
    <WidgetShell>
      <WidgetHeader
        ...
        action={
          <Link href="/courses" className="text-xs transition-colors" style={{ color: 'var(--text-faint)' }}>
  ...
  return (
    <WidgetShell>
      <WidgetHeader
        ...
        action={
          <Link href="/today" className="text-xs transition-colors" style={{ color: 'var(--text-faint)' }}>
