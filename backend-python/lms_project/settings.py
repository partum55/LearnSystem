...
if USE_SUPABASE:
    # Required env vars: SUPABASE_URL, SUPABASE_KEY, SUPABASE_BUCKET
    SUPABASE_URL = os.getenv('SUPABASE_URL')
    SUPABASE_KEY = os.getenv('SUPABASE_KEY')
    SUPABASE_BUCKET = os.getenv('SUPABASE_BUCKET')
    SUPABASE_BUCKET_PUBLIC = os.getenv('SUPABASE_BUCKET_PUBLIC', 'False')
    # If using supabase set our custom storage backend
