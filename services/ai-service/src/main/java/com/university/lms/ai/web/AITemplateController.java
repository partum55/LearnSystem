...
/** REST controller for AI course templates. API Version: v1 */
@RestController
...
public class AITemplateController {
  ...
  /** Get all public templates GET /api/ai/templates */
  @GetMapping
  ...
  /** Get templates by category GET /api/ai/templates?category=programming */
  ...
  /** Get popular templates GET /api/ai/templates/popular */
  @GetMapping("/popular")
  ...
  /** Get template by ID GET /api/ai/templates/{id} */
  @GetMapping("/{id}")
  ...
  /** Create new template POST /api/ai/templates */
  @PostMapping
  ...
  /** Update template PUT /api/ai/templates/{id} */
  @PutMapping("/{id}")
  public ResponseEntity<CourseTemplate> updateTemplate(
      @PathVariable UUID id, @Valid @RequestBody CourseTemplate template) {
    log.info("Updating template: {}", id);
    return ResponseEntity.ok(templateService.updateTemplate(id, template));
  }

  /** Delete template (soft delete) DELETE /api/ai/templates/{id} */
  @DeleteMapping("/{id}")
  ...
  /** Generate course from template POST /api/ai/templates/{id}/generate */
  ...
  /** Initialize default templates POST /api/ai/templates/initialize */
