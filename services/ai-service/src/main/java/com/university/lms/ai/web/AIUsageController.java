...
/**
 * REST controller for AI usage and cost tracking. Provides endpoints for users to view their AI
 * usage and for admins to view system-wide statistics.
 */
@RestController
...
public class AIUsageController {
  ...
  public ResponseEntity<AIUserUsage> getUserUsage(@PathVariable String userId) {
    ...
    return usage.map(ResponseEntity::ok).orElse(ResponseEntity.noContent().build());
  }
