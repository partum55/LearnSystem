...
/**
 * Mapper for Course-related entities and DTOs.
 * Using manual mapping for better control and clarity.
 */
@Component
public class CourseMapper {
    ...
    public Course toEntity(CreateCourseRequest request, java.util.UUID ownerId) {
        ...
        return Course.builder()
            ...
            .ownerId(ownerId)
            .visibility(request.getVisibility() != null ? request.getVisibility() : com.university.lms.common.domain.CourseVisibility.DRAFT)
            ...
            .status(request.getStatus() != null ? request.getStatus() : com.university.lms.common.domain.CourseStatus.DRAFT)
    ...
    public ModuleDto toDto(com.university.lms.course.domain.Module module) {
        ...
        if (module.getResources() != null && !module.getResources().isEmpty()) {
            dto.setResources(module.getResources().stream()
                .map(this::toDto)
                .toList());
        }
