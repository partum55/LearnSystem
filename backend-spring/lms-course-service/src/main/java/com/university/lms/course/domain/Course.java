...
/**
 * Course entity with multilingual support and comprehensive tracking.
 * Migrated from Django Course model with all features preserved.
 */
@Entity
...
public class Course {
    ...
    public String getTitle(String language) {
        return "uk".equals(language) ? titleUk : (titleEn != null ? titleEn : titleUk);
    }

    public String getDescription(String language) {
        return "uk".equals(language) ? descriptionUk : (descriptionEn != null ? descriptionEn : descriptionUk);
    }

    public int getCurrentEnrollment() {
        return (int) members.stream()
                .filter(m -> "STUDENT".equals(m.getRoleInCourse()) && "active".equals(m.getEnrollmentStatus()))
                .count();
    }
    ...
    public boolean isActive() {
        return isPublished && status == CourseStatus.PUBLISHED;
    }
}
