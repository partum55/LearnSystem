...
CREATE INDEX idx_peer_review_assignment ON peer_reviews(assignment_id);
CREATE INDEX idx_peer_review_reviewer ON peer_reviews(reviewer_user_id);
CREATE INDEX idx_peer_review_reviewee ON peer_reviews(reviewee_user_id);
CREATE INDEX idx_peer_review_submission ON peer_reviews(submission_id);
CREATE INDEX idx_peer_review_status ON peer_reviews(status);

-- Create indexes for peer_review_rubrics
CREATE INDEX idx_peer_review_rubric_assignment ON peer_review_rubrics(assignment_id);
CREATE INDEX idx_peer_review_rubric_position ON peer_review_rubrics(assignment_id, position);

-- Create indexes for peer_review_ratings
CREATE INDEX idx_peer_review_rating_review ON peer_review_ratings(peer_review_id);
CREATE INDEX idx_peer_review_rating_rubric ON peer_review_ratings(rubric_id);
