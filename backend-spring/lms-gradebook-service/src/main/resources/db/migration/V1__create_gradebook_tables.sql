...
CREATE INDEX idx_gradebook_category_course ON gradebook_categories(course_id);
...
CREATE INDEX idx_gradebook_entry_course_student ON gradebook_entries(course_id, student_id);
CREATE INDEX idx_gradebook_entry_status ON gradebook_entries(status);
CREATE INDEX idx_gradebook_entry_graded_at ON gradebook_entries(graded_at);
CREATE INDEX idx_gradebook_entry_created_at ON gradebook_entries(created_at);
...
CREATE INDEX idx_grade_history_entry ON grade_histories(gradebook_entry_id);
CREATE INDEX idx_grade_history_changed_at ON grade_histories(changed_at);
...
CREATE INDEX idx_grade_summary_course_student ON course_grade_summaries(course_id, student_id);
CREATE INDEX idx_grade_summary_current_grade ON course_grade_summaries(current_grade);
