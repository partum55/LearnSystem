package com.university.lms.gradebook.config;
...
import com.university.lms.gradebook.security.JwtAuthenticationFilter;
...
/**
 * Enhanced security configuration for Gradebook Service.
 * Features:
 * - JWT authentication
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Enhanced security headers (OWASP recommendations)
