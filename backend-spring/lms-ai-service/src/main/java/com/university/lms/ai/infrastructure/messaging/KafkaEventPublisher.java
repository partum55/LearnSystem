...
public class KafkaEventPublisher {
     ...
     */
    public void publishContentGenerated(String contentType, LLMResponse response,
     ...
     */
    public void publishGenerationFailed(String contentType, String courseId,
        ...
        AIContentGeneratedEvent event = AIContentGeneratedEvent.failure(
                contentType, courseId, userId, errorMessage);
