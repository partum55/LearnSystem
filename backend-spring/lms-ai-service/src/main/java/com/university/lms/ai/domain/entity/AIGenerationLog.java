...
public class AIGenerationLog {
  ...
  public static AIGenerationLog success(
      String contentType,
      String provider,
      String model,
      int promptTokens,
  ...
  public static AIGenerationLog failure(
      String contentType, String provider, String errorMessage, String userId, String courseId) {
    return AIGenerationLog.builder()
        .contentType(contentType)
