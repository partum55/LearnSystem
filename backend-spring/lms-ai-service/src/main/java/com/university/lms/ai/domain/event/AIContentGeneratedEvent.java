...
public class AIContentGeneratedEvent {
     ...
     */
    public static AIContentGeneratedEvent success(String contentType, String courseId,
            String userId, String provider, String model,
     ...
     */
    public static AIContentGeneratedEvent failure(String contentType, String courseId,
