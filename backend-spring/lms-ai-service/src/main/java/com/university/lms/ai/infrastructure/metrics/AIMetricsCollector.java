...
/**
 * Centralized collector for AI service metrics.
...
public class AIMetricsCollector {
    ...
    public void recordGeneration(String type, String provider, long latencyMs, boolean success) {
        ...
        log.debug("Recorded AI generation metric: type={}, provider={}, latency={}ms, success={}",
                type, provider, latencyMs, success);
    }
    ...
    public void recordTokenUsage(String provider, int promptTokens, int completionTokens) {
        ...
        log.debug("Recorded token usage: provider={}, prompt={}, completion={}",
    ...
    public void stopTimer(Timer.Sample sample, String name, String... tags) {
        Timer.Builder builder = Timer.builder(METRIC_PREFIX + name)
                .description("Duration metric");
