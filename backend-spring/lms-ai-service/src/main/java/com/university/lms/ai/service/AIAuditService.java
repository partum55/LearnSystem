...
/**
 * Service for auditing AI generation requests.
 * Logs all prompts, responses, and metrics for observability and compliance.
 */
@Service
...
public class AIAuditService {
    ...
    public void logSuccess(String contentType, String promptTemplateName,
                           LLMResponse response, String userId, String courseId) {
        try {
            ...
            log.info("AI audit log: type={}, provider={}, tokens={}, latency={}ms, user={}",
                    contentType, response.getProvider(),
                    response.getTotalTokens(), response.getLatencyMs(), userId);
     ...
     */
    @Async("aiTaskExecutor")
    public void logFailure(String contentType, String promptTemplateName,
        ...
        try {
            ...
            log.warn("AI audit log (failure): type={}, provider={}, error={}, user={}",
                    contentType, provider, errorMessage, userId);
    ...
    public List<AIGenerationLog> getRecentLogsForUser(String userId, int limit) {
        return logRepository.findByUserIdOrderByCreatedAtDesc(
                userId,
