 ...
 * Replaces manual Thread creation with managed thread pools.
 */
@Configuration
@EnableAsync
@Slf4j
public class AsyncConfig implements AsyncConfigurer {
    ...
    /**
     * Task executor for AI generation tasks.
     * Configured with bounded queue to prevent OOM under load.
     */
    @Bean("aiTaskExecutor")
    public TaskExecutor aiTaskExecutor() {
        ...
        log.info("AI Task Executor initialized: corePoolSize={}, maxPoolSize={}, queueCapacity={}",
