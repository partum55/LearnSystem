...
Course management microservice for the Learning Management System.
...
### Run with Docker
```bash
docker-compose up lms-course-service
```
...
- **lms-assessment-service** - Assignments and quizzes (planned)
