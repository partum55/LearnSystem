...
CREATE INDEX IF NOT EXISTS idx_rubric_history_assignment ON rubric_score_history(assignment_id);
CREATE INDEX IF NOT EXISTS idx_rubric_history_submission_version ON rubric_score_history(submission_id, rubric_version);
CREATE INDEX IF NOT EXISTS idx_rubric_history_graded_at ON rubric_score_history(graded_at);
